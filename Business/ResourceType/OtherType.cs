...
namespace QJVRMS.Business.ResourceType
{
    ...
    /// 其他类型的相关设置
    /// </summary>
    public class OtherType : IResourceType
    {

        public string SourcePath {
            get {
                return ConfigurationManager.AppSettings["otherSourcePath"];
            }
        }

        public string[] SourcePaths {
            get {
                return ConfigurationManager.AppSettings["otherSourcePath"].Split(',');
            }
        }

        public string PreviewPath {
            get {
                return ConfigurationManager.AppSettings["otherPreviewPath"];
            }
        }

        public string[] PreviewPaths {
            get {
                return ConfigurationManager.AppSettings["otherPreviewPath"].Split(',');
            }
        }
