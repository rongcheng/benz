<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="QJ_Header_DefaultPage.ascx.cs" Inherits="WebUI.UserControls.QJ_Header_DefaultPage" %>
...
<div class="header" id="header">	
	<h1><a href="/" target="_top"><img src="/image/common/logo.gif" alt="<%=WebUI.UIBiz.CommonInfo.WebSite_Title %>" /></a>
    </h1>
	<div class="services" >
		<asp:Label ID="lblLoginName" runat="server"  Font-Bold="true"></asp:Label>
        欢迎您！
        <asp:LoginStatus ID="logStatus" runat="server"  LogoutText="注销"  onloggingout="logStatus_LoggingOut" />
...
<div class="nav">
	<h2 class="index"  style="width:180px">全景网 - 栏目导航</h2>
	<ul>	
	<li<%=currentCss[0] %>><a href="/" target="_top">首页</a></li>
	...
	<%--<li<%=currentCss[4] %>><a href="javascript:newOrder();">拍摄申请</a></li>--%>
