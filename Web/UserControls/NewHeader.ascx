<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="NewHeader.ascx.cs" Inherits="WebUI.UserControls.NewHeader" %>
<div class="logoContainer">
    <div class="logoA"></div>    
    <div class="logOut">
        <div  class="showUserName"  ><asp:Label ID="lblLoginName" runat="server"  Font-Bold="true"></asp:Label></div>
        欢迎您！
