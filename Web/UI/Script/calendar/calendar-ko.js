...
"\n\n" +
"날짜 선택:\n" +
"- 연도를 선택하려면 \xab 또는 \xbb 버튼을 사용합니다\n" +
"- 달을 선택하려면 " + String.fromCharCode(0x2039) + " 또는 " + String.fromCharCode(0x203a) + " 버튼을 누르세요\n" +
...
Calendar._TT["DAY_FIRST"] = "%s을 한주의 시작요일로";
