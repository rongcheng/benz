﻿-function(){
	sharetoFloatContain.centerpop.innerHTML = '<div style="border:10px solid #7F7F7F; width:300px;">\
		<div class="shareto_div_01" style="width:100%;">\
			<div style="background:#F2F2F2;line-height:200%;padding-left:5px;">\
				...
				<div style="float:right"><img src="http://shareto.googlecode.com/svn/trunk/img/img_exit.gif" border="0" style="margin:4px 4px 0 0;cursor:pointer;" onclick="sharetoFloatContain.centerClose()"/></div>\
			...
			<div style=" background:#F2F2F2;border-bottom:1px solid #E5E5E5;padding-left:5px;">\
				...
				<input name="" type="text" onclick="this.value=\'\'" value="输入网站名或拼音缩写" style="background:#FFFFFF;border:none;margin:7px 0 0 28px;width:240px;" onkeyup = "sharetoFloatContain.choose(this)" />\
				</div>\
			</div>\
